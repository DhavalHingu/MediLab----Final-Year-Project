...
?>
			  ...
			  <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li><a href="diagno.php"><i class="fa fa-angle-right"></i> Paient's Diagnosis</a></li>
                  <li><a href="pd.php"><i class="fa fa-angle-right"></i> Patient's Details</a></li>
                </ul>
              </li>
              <li class="treeview">
                <a href="charts.php">
...
$type=$row1['id_name'];
	...
	$i=1;
 	$sql_sel_sub="SELECT * from appointment where `doc` LIKE '%$type%' AND `checks` = 0 ";
	...
	echo "<tr>";
		echo "<td>".$i++."</td>";
			...
			echo "<td>".$f."</td>";
			echo "<td>".$g."</td>";
			echo "<td>"."<a href='confirm.php?email=" .$row['email'] ."&doc=" .$row['doc'] ."'>Confirm</a></td>";
...
<div style="background-color: #5bc0de;">
 <h1 class="well">Confirmed Appointments</h1>
<table class="data-table"><br> <br>
...
$type=$row1['id_name'];
	...
	$i=1;
 	$sql_sel_sub="SELECT * from appointment where `doc` LIKE '%$type%' AND `checks` = 1 ";
 	$res_sel_sub= mysqli_query($a,$sql_sel_sub);
